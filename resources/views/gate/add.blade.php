...
<main class="main">
	<div class="page-title-box">
	    	<span class="page-title">Create New Area</span>
	        <span class="page-description">Complate Form And Press Submit</span>
	    </div>
	    <div class="col-xs-12">
	        <div class="main-box">

			<form method="POST" class='login-form' action="/gate/store" enctype="multipart/form-data">
				 @if (count($errors) > 0)
						     ...
						     <select name="id_area" class="form-control">
						     	 ...
						     	 <?php 
							        foreach ($area as  $value) {
							        	?>
						     	     <option value="<?php echo $value->id_area ?>"><?php echo $value->name ?></option>
						     	<?php } ?>
						     </select>
						</div>
